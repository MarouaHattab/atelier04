...
class WidgetProduit extends StatefulWidget {
  Produit produit; // This holds the product data

  WidgetProduit({super.key, required this.produit}); // Constructor to pass the product data
            ...
            Stack(
              children: [
                Container(
                  ...
                  child: InkWell(
                    child: Image.network(widget.produit.imageUrl, fit: BoxFit.cover),
                    onTap: () {
                      // When a product is tapped, navigate to the detail screen
                      Navigator.pushNamed(
                        context, 
                        "/detailProduit", // The name of the route
                        arguments: widget.produit, // Pass the product data to the detail screen
                      );
                    },
                  ),
                ),
